...
def create_resume_docx(user_details, summary, experience, projects, skills, certificates, output_folder):
    # Create a docx file
    doc = docx.Document()
    ...
    # Save docx file
    docx_path = os.path.join(output_folder, f"{user_details['name']}_resume.docx")
    doc.save(docx_path)
    ...
    # Save pdf file
    pdf_path = os.path.join(output_folder, f"{user_details['name']}_resume.pdf")
